...
function displayPics(){
  ...
  // 'let rando' in this case is being logged outside of its containing block and is 'undefined'. If 'var rando' can be logged because 'let' does not create a property on the global object, while 'var' does create a property on the global object. 
  console.log(viewed);
